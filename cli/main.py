...
def update_display(layout, spinner_text=None, stats_handler=None, start_time=None):
    ...
    layout["header"].update(
        Panel(
            "[bold green]Welcome to TradingAgents Report CLI[/bold green]\n"
            "[dim]Hosted desk: [https://agent.tradingagentsreport.com](https://agent.tradingagentsreport.com)[/dim]",
            title="Welcome to TradingAgents Report",
            border_style="green",
            padding=(1, 2),
            expand=True,
        )
...
def get_user_selections():
    ...
    welcome_content += "[bold green]TradingAgents Report: Multi-Agents LLM Financial Research Framework - CLI[/bold green]\n\n"
    welcome_content += "[bold]Workflow Steps:[/bold]\n"
    welcome_content += "I. Analyst Team → II. Research Team → III. Trader → IV. Risk Management → V. Portfolio Management\n\n"
    welcome_content += (
        "[dim]Based on [Tauric Research / TradingAgents](https://github.com/TauricResearch/TradingAgents)[/dim]"
    )
    ...
    welcome_box = Panel(
        ...
        padding=(1, 2),
        title="Welcome to TradingAgents Report",
        subtitle="Multi-Agents LLM Financial Research Framework",
    )
